/* src/config/worldpaycoin-config.h.  Generated from worldpaycoin-config.h.in by configure.  */
/* src/config/worldpaycoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef WPAY_CONFIG_H

#define WPAY_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.worldpaycoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "WorldPayCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "WorldPayCoin Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "worldpaycoin"

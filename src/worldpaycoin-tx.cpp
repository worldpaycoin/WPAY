...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("WorldPayCoin Core worldpaycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  worldpaycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded worldpaycoin transaction") + "\n" +
                               "  worldpaycoin-tx [options] -create [commands]   " + _("Create hex-encoded worldpaycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded worldpaycoin transaction

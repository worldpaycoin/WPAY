...
/** Utility functions used by the WPAY Qt UI.
 */
namespace GUIUtil
{
...
// Render WPAY addresses in monospace font
...
// Parse "worldpaycoin:" URI into recipient object, return true on successful parsing

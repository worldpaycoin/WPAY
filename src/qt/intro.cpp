...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("WPAY Core"),
     ...
     * override -datadir in the worldpaycoin.conf file in the default data directory
     * (to be consistent with worldpaycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())

                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzWPAYPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzWPAYPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzWPAYPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzWPAYPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the WPAY RPC console.") + "<br>" +

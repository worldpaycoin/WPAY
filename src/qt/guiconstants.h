...
/* WorldPayCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "WPAY"
#define QAPP_ORG_DOMAIN "worldpaycoin.org"
#define QAPP_APP_NAME_DEFAULT "WPAY-Qt"
#define QAPP_APP_NAME_TESTNET "WPAY-Qt-testnet"

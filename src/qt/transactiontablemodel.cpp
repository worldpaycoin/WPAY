...
// Copyright (c) 2016-2018 The ZillionFLUX developers
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("WPAY Stake");
    case TransactionRecord::StakeZWPAY:
        return tr("zWPAY Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted WPAY to zWPAY");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zWPAY");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received WPAY from zWPAY");
    case TransactionRecord::ZerocoinSpend_Change_zWorldPayCoin:
        return tr("Minted Change as zWPAY from zWPAY Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zWPAY to WPAY");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zWorldPayCoin:
        return tr("Anonymous (zWPAY Transaction)");
    case TransactionRecord::StakeZWPAY:
        return tr("Anonymous (zWPAY Stake)");
    case TransactionRecord::SendToSelf:
    default:

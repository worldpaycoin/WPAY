                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WPAY Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WPAY address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and worldpaycoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zWPAY"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WPAY Core"), this);
    aboutAction->setStatusTip(tr("Show information about WPAY Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WPAY"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WPAY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WPAY addresses"));
    ...
    openAction->setStatusTip(tr("Open a WPAY: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WPAY Core help message to get a list with possible WPAY command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WPAY Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WPAY network", "", count));
}
...
{
    QString strTitle = tr("WPAY Core"); // default title

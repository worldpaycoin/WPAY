...
public:
    ...
    bool WriteZWPAYSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZWPAYSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZWPAYSeed_deprecated(uint256& seed);
    bool EraseZWPAYSeed();
    bool EraseZWPAYSeed_deprecated();

    bool WriteZWPAYCount(const uint32_t& nCount);
    bool ReadZWPAYCount(uint32_t& nCount);

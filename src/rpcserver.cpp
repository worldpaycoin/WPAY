...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WPAY features */
        {"worldpaycoin", "masternode", &masternode, true, true, false},
        {"worldpaycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"worldpaycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"worldpaycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"worldpaycoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"worldpaycoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"worldpaycoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"worldpaycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"worldpaycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"worldpaycoin", "startmasternode", &startmasternode, true, true, false},
        {"worldpaycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"worldpaycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"worldpaycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"worldpaycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"worldpaycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"worldpaycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"worldpaycoin", "mnbudget", &mnbudget, true, true, false},
        {"worldpaycoin", "preparebudget", &preparebudget, true, true, false},
        {"worldpaycoin", "submitbudget", &submitbudget, true, true, false},
        {"worldpaycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"worldpaycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"worldpaycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"worldpaycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"worldpaycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"worldpaycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"worldpaycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"worldpaycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"worldpaycoin", "mnsync", &mnsync, true, true, false},
        {"worldpaycoin", "spork", &spork, true, true, false},
        {"worldpaycoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> worldpaycoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:39998/\n";
}

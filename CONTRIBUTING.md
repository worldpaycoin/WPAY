Contributing to WPAY Core
============================

The WPAY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WPAY Core project, and is not to be
confused with overall WPAY Network Protocol consensus changes.

Whether a pull request is merged into WPAY Core rests with the project merge
...
Patches that change WPAY consensus rules are considerably more involved than
...
Where a patch set proposes to change the WPAY consensus, it must have been
...
The project leader is the release manager for each WPAY Core release.

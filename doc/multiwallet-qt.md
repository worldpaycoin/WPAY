...
In order to support loading of multiple wallets in worldpaycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is worldpaycoin.cpp.
...
Changes to worldpaycoin.cpp
----------------------
worldpaycoin.cpp is the entry point into worldpaycoin-qt, and as such, will require some minor modifications to provide hooks for

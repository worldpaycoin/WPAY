...
This mechanism has been integrated into Bitcore-Node-WPAY which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/WPAY-Project/insight-api-worldpaycoin#web-socket-api](https://github.com/WPAY-Project/insight-api-worldpaycoin#web-socket-api) 
* API: [https://github.com/WPAY-Project/insight-api-worldpaycoin#swifttx-transactions](https://github.com/WPAY-Project/insight-api-worldpaycoin#swifttx-transactions) 
...
By default, the WPAY Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the WPAY Core daemon:
